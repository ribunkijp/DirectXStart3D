...
void Player::InitVertexData(ID3D11Device* device, ID3D11DeviceContext* context) {
    ...
    Vertex vertices[] =
    {
        ...
        { {-0.5f, 0.0f, 0.5f}, {1,0,0,1}, {0.0f,1.0f}, {0,0,1}, { 1,0,0} },
        { {-0.5f, 1.0f, 0.5f}, {1,0,0,1}, {0.0f,0.0f}, {0,0,1}, { 1,0,0} },
        { { 0.5f, 1.0f, 0.5f}, {1,0,0,1}, {1.0f,0.0f}, {0,0,1}, { 1,0,0} },
        { { 0.5f, 0.0f, 0.5f}, {1,0,0,1}, {1.0f,1.0f}, {0,0,1}, { 1,0,0} },

        // 后 (z=-0.5) - 绿色 (R=0, G=1, B=0, A=1)
        { { 0.5f, 0.0f,-0.5f}, {0,1,0,1}, {0.0f,1.0f}, {0,0,-1}, {-1,0,0} },
        { { 0.5f, 1.0f,-0.5f}, {0,1,0,1}, {0.0f,0.0f}, {0,0,-1}, {-1,0,0} },
        { {-0.5f, 1.0f,-0.5f}, {0,1,0,1}, {1.0f,0.0f}, {0,0,-1}, {-1,0,0} },
        { {-0.5f, 0.0f,-0.5f}, {0,1,0,1}, {1.0f,1.0f}, {0,0,-1}, {-1,0,0} },

        // 左 (x=-0.5) - 橙色 (R=1, G=0.5, B=0, A=1)
        { {-0.5f, 0.0f,-0.5f}, {1,0.5,0,1}, {0.0f,1.0f}, {-1,0,0}, {0,0, 1} },
        { {-0.5f, 1.0f,-0.5f}, {1,0.5,0,1}, {0.0f,0.0f}, {-1,0,0}, {0,0, 1} },
        { {-0.5f, 1.0f, 0.5f}, {1,0.5,0,1}, {1.0f,0.0f}, {-1,0,0}, {0,0, 1} },
        { {-0.5f, 0.0f, 0.5f}, {1,0.5,0,1}, {1.0f,1.0f}, {-1,0,0}, {0,0, 1} },

        // 右 (x=+0.5) - 紫色 (R=0.5, G=0, B=0.5, A=1)
        { { 0.5f, 0.0f, 0.5f}, {0.5,0,0.5,1}, {0.0f,1.0f}, {1,0,0}, {0,0,-1} },
        { { 0.5f, 1.0f, 0.5f}, {0.5,0,0.5,1}, {0.0f,0.0f}, {1,0,0}, {0,0,-1} },
        { { 0.5f, 1.0f,-0.5f}, {0.5,0,0.5,1}, {1.0f,0.0f}, {1,0,0}, {0,0,-1} },
        { { 0.5f, 0.0f,-0.5f}, {0.5,0,0.5,1}, {1.0f,1.0f}, {1,0,0}, {0,0,-1} },

        // 上 (y=+0.5) - 蓝色 (R=0, G=0, B=1, A=1)
        { {-0.5f, 1.0f, 0.5f}, {0,0,1,1}, {0.0f,1.0f}, {0,1,0}, { 1,0,0} },
        { {-0.5f, 1.0f,-0.5f}, {0,0,1,1}, {0.0f,0.0f}, {0,1,0}, { 1,0,0} },
        { { 0.5f, 1.0f,-0.5f}, {0,0,1,1}, {1.0f,0.0f}, {0,1,0}, { 1,0,0} },
        { { 0.5f, 1.0f, 0.5f}, {0,0,1,1}, {1.0f,1.0f}, {0,1,0}, { 1,0,0} },

        // 下 (y=-0.5) - 粉色 (R=1, G=0.7, B=0.8, A=1)
        { {-0.5f, 0.0f,-0.5f}, {1,0.7,0.8,1}, {0.0f,1.0f}, {0,-1,0}, { 1,0,0} },
        { {-0.5f, 0.0f, 0.5f}, {1,0.7,0.8,1}, {0.0f,0.0f}, {0,-1,0}, { 1,0,0} },
        { { 0.5f, 0.0f, 0.5f}, {1,0.7,0.8,1}, {1.0f,0.0f}, {0,-1,0}, { 1,0,0} },
        { { 0.5f, 0.0f,-0.5f}, {1,0.7,0.8,1}, {1.0f,1.0f}, {0,-1,0}, { 1,0,0} },
    };
